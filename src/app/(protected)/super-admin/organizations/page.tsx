...
const OrganizationManager: React.FC<OrganizationManagerProps> = ({}) => {
	...
	const onEdit = (org: Organization) => {
		// Handle edit logic, e.g. open a modal with org details
	};
	const onDelete = (id: string) => {
		// Handle delete logic, e.g. show confirmation and call API
	};
	const onCreate = () => {
		// Handle create logic, e.g. open a modal for creating a new org
	};
	useEffect(() => {
		...
		<div className="container mx-auto p-4">
			...
			{organizations.length === 0 && !isLoading && (
				<div className="text-center py-12 border-2 border-dashed border-border rounded-lg">
					...
					<Button onClick={onCreate} className="btn-brand">
